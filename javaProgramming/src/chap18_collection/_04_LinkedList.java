...
public class _04_LinkedList {
	...
	public static void main(String[] args) {
		...
		//1. ArrayList, LinkedList의 속도비교
		//1-1. 순차적으로 데이터를 넣는 속도 비교 
		List<String> arrayList = new ArrayList<>();           //순차적으로 접근할 일이 많아서 array를 많이 씀.
		...
		System.out.println("ArrayList 중간에 데이터를 추가하는데 걸린 시간 : " +
				(endTime - startTime) + "나노초입니다.");
		...
		System.out.println("linkedList 중간에 데이터를 추가하는데 걸린 시간 : " +
				(endTime - startTime) + "나노초입니다.");
