...
public class _01_ArrayList {
	...
	public static void main(String[] args) {
		...
		//2. Java 17버전 이전에서는 ArrayList 생성자에서도 엘레먼트의 제네릭 타입을 지정해야 됐지만 
		// Java 17 버전 부터는 제네릭 타입을 명시하지 않아도 된다.
		// 자바 17버전 
		...
		//sort메소드는 static으로 선언되어 있어서 Collections 클래스에서 바로 사용한다.
		...
		//addAll(Collection c) : 매개변수로 전달받은 Collection 객체의 데이터를 마지막에 모두 추가
		intList2.add(10);
		intList2.add(13);
