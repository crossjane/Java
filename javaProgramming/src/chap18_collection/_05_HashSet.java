...
public class _05_HashSet {
	...
	public static void main(String[] args) {
		...
		//2. Set 데이터 추가 // 랜덤한 순서로저장. 인덱스 x . 중복도 x
		strSet.add("Java");
		strSet.add("JDBC");
