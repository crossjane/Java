...
public class _01_JDBC_Select {
	...
	public static void main(String[] args) {
		...
		try {
			//5. 위에서 지정한 DataBase	드라이버로드
			Class.forName(JDBC_DRIVER);
			
			//6.DriverManager 클래스를 통해 DB연결 객체 얻기 
			...
			//SELECT => executeQuery메소드 사용 
			//INSERT, UPDATE, DELTE => executeUpdate 메소드 사용
			...
			while(rs.next()) {
				...
				System.out.println("학번 " + sno + "이름 : " + sname + ", 기말고사평균점수: " + avgRes );
			}
