...
public class _04_Pipeline {
	 ...
	 */
		...
		//1. 스트림 파이프라인을 통해서 최대한도가 5000이상인 카드정보출력
...
//		//한도가 5000이상인 CreditCard만 모아서 새로운 Stream생성
//		//Stream<CreditCard>
//		Stream<CreditCard> overFiveStream = creditCardStream.filter(Card -> Card.getLimit() >= 5000);
//		
//		//forEach로 출력 
//		overFiveStream.forEach(card -> card.cardInfo());
		
		//1-2. 파이프라인으로 구성
		creditCardList.stream() 		//Stream<CreditCard>
										//최대 한도가 5000이상인 CreditCard객체만 모은 Stream<CreditCard>
