...
public class _05_LambdaEx01 {
	...
	//검사해서 첫 번째 문자열에 두번째 문자열이 포함되어 있으면 
	//감사합니다.에서 합니의 인덱스는 2입니다. 라고출력.
	//검사해서 첫번째 문자열에 두번쨰 문자열이 포함되어 있지 않으면
	...
	public static void findIndex(IndexOfString indexOfString) {
		...
		//findIndex메소드를 호출하면서 매개변수로 전달한 람다식이 실행된다.
		int index = indexOfString.indexOf(str1, str2);
		
		//포함하고 있지않으면 -1 반환. 포함할떄는 포함 갯수를 리턴
		if(index !=-1) {
