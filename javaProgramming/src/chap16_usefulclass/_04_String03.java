...
public class _04_String03 {
	...
	public static void main(String[] args) {
		...
		//2. substring: 주어진 인덱스로 잘 알려진 문자열을 리턴 
		// 매개변수가 하나일 때는 주어진 매개변수부터 마지막 인덱스의 문자까지 잘라진 문자열 리턴
		System.out.println(str2.substring(4));
		
		//매개변수가 두개 일 때는 첫 번째 매개변수 부터 두번째 매개변수의 인덱스 까지의 문자열을 잘라서 리턴
		//두번째 매개변수의 인덱스 문자는 포함하지 않는다. 
		...
		// valueOf는 static메소드라 String.valueOf로 사용한다.
