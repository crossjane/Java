...
public class _06_StringBuffer01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(sb3.toString().equals(sb4.toString()));    //String 값으로 리턴.
		
		
		System.out.println(String.valueOf(sb3).equals(String.valueOf(sb4)));  //valueOf로도 사용가능
