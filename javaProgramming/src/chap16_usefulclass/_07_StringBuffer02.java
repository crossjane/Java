...
public class _07_StringBuffer02 {
	...
	public static void main(String[] args) {
		...
		// sb3는 16크기의 버퍼를 생성해서 append메소드로 문자열을 추가했기 때문에 
		...
		// 4. delete : 매개변수로 주어진 시작 인덱스부터 끝 인덱스까지의 문자열을 삭제한 새로운 StringBuffer를 리턴.
		// 끝 인덱스의 문자는 포함되지 않는다. 
		sb2.delete(3, 7);
		
		System.out.println(sb2);
		
		//delete메소드의 매개변수가 하나일 때는 해당인덱스의 문자 하나만 삭제 
		sb2.append("camp")
		   .deleteCharAt(3);
		System.out.println(sb2);
		...
		//StringBuffer sb5 = sb2.reverse(); 이렇게 해도됨.
		sb2.reverse();
		System.out.println(sb2);
