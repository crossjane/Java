...
public class _02_DiffOfTwoDate {
	...
	public static void main(String[] args) {
		...
		System.out.println("cal2 부터 cal1까지 " + (diff / 1000 / 60 / 60 / 24 /30 / 365) + "년이 지났습니다.");
		...
		System.out.println("cal2 부터 cal1까지 " + diffYear + "년" + diffDate + "일" +
						diffTime + "시간" + diffMin + "분" + diffSec + "초가 지났습니다.");
		
		System.out.println("cal2 부터 cal1까지 " +
		(diff / 1000 / 60 / 60 / 24 /30 / 365) + "년" +
