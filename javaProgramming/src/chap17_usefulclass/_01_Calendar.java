...
public class _01_Calendar {
	...
	public static void main(String[] args) {
		...
		// getInstance()를 통해 생성되는 객체는 Calender를 상속받아 구현된
		// GregrianCalendar클래스이다.
		...
		// WEEK_OF_YEAR(올해의 몇번째 주인지 표시)
		// WEEK_OF_MONTH(이달의 몇번째 주인지 표시)
		...
		System.out.println("올해의 몇째주 : " + calendar.get(Calendar.WEEK_OF_YEAR));
		System.out.println("이번달의 몇째주 : " + calendar.get(Calendar.WEEK_OF_MONTH));
		...
		// set메소드는 Calendar 객체가 생성된 후에 사용가능하다.
		Calendar oneDay = Calendar.getInstance();		
		oneDay.set(2024, 3, 24, 22, 53, 30);					//2024년 4월 24일 22시 53분 30초인 시간을 갖는 Calendar객체
