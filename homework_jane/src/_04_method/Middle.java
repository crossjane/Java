...
//		1. int 배열 한 개를 매개변수로 받아서 역순으로 저장된 새로운 배열을 리턴하는
		//메소드를 구현하세요.  
...
//	}
//	
	public static char[] convertChArr(char[] chArr) {		//매개변수로받아 줬기 때문에 아래서 chArr쓸수 있음. 
															//만약 매개변수를 (빈칸으로두었을때) 안받아줬으면 밑에서 chArr받아줘야함(선언해야함)
